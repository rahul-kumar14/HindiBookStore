...
VALUES (1, 'कहानी (Story)');
SELECT changes();

INSERT INTO "Categories" ("Id", "Name")
VALUES (2, 'उपन्यास (Novel)');
SELECT changes();

INSERT INTO "Categories" ("Id", "Name")
VALUES (3, 'कविता (Poetry)');
SELECT changes();

INSERT INTO "Categories" ("Id", "Name")
VALUES (4, 'आत्मकथा (Autobiography)');
SELECT changes();
...
VALUES ('20260113105438_InitialCreate', '10.0.2');

COMMIT;

BEGIN TRANSACTION;
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260114105412_InitialSqlServerMigration', '10.0.2');
